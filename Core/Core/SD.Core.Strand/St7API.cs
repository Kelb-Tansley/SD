using SD.Core.Strand.Helpers;
using System.Runtime.InteropServices;
using System.Text;

namespace SD.Core.Strand;
public static class St7
{
    ...
    [DllImport(DllImportHelper.DllImportLocation)]
    ...
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7GetModelWindowHandle(int uID, ref nint Handle);
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7SetModelWindowParent(int uID, nint Handle);
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7GetModelWindowParent(int uID, ref nint Handle);
    [DllImport(DllImportHelper.DllImportLocation)]
    ...
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7CreateAnimationEmbedded(int uID, nint pHandle, int[] Integers, ref int aHandle);
    [DllImport(DllImportHelper.DllImportLocation)]
    ...
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7GetBeamAxisSystemInitialBirth(int uID, int BeamNum, int ResultCase, double[] Doubles);
    [DllImport(DllImportHelper.DllImportLocation)]
    public static extern int St7GetBeamAxisSystemInitialGNL(int uID, int BeamNum, int ResultCase, double[] Doubles);
    [DllImport(DllImportHelper.DllImportLocation)]
