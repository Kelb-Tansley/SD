...
public interface IFemModelParameters
{
    ...
    public ObservableCollection<Section> NonDesignableSections { get; set; }
    ...
    public void Clear();
    public void SetNonDesignableSections(IEnumerable<Section> sections)
    {
        NonDesignableSections = new ObservableCollection<Section>(sections);
    }
}
